        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title mb-0">Tambah Kategori Pembayaran</h3>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('admin.kategori-pembayaran.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('nominal_default') is-invalid @enderror" 
                                           id="nominal_default" name="nominal_default" value="{{ old('nominal_default') }}" required min="0">
