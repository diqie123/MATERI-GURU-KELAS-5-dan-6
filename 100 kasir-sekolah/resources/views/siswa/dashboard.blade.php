                    ...
                    <div class="p-6 text-gray-900">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">{{ $tagihanBelumDibayar }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6 text-gray-900">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">Rp {{ number_format($totalTagihan, 0, ',', '.') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6 text-gray-900">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">{{ $transaksiTerakhir ? $transaksiTerakhir->tanggal_transaksi->format('d/m/Y') : '-' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($riwayatPembayaran as $index => $transaksi)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        @foreach($transaksi->transactionDetails as $detail)
                                            {{ $detail->paymentItem->nama_item }}<br>
                                        @endforeach
                                    </td>
